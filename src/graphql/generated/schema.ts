...
export type CalendarEventType = "availability" | "unavailability";
...
export type GetMeetingEventsQuery = {
  __typename?: "Query";
  meetingEventsByDateRange: Array<{
    __typename?: "MeetingEvent";
    id: string;
    startDateTime: string;
    endDateTime: string;
...
export type GetPendingConfirmationsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetPendingConfirmationsQuery = {
  __typename?: "Query";
  pendingMeetingConfirmations: Array<{
    __typename?: "MeetingEvent";
    id: string;
    startDateTime: string;
    endDateTime: string;
...
export type ConfirmMeetingMutation = {
  __typename?: "Mutation";
  confirmMeeting: {
    __typename?: "MeetingEvent";
    id: string;
...
export type RejectMeetingMutation = {
  __typename?: "Mutation";
  rejectMeeting: {
    __typename?: "MeetingEvent";
    id: string;
...
export function getSdk(
  ...
  return {
    ...
    GetCalendarEvents(
      ...
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<GetCalendarEventsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCalendarEventsQuery>({
    ...
    UpdateCalendarEvent(
      variables: UpdateCalendarEventMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<UpdateCalendarEventMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateCalendarEventMutation>({
            document: UpdateCalendarEventDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    DeleteCalendarEvent(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeleteCalendarEventMutation>({
            document: DeleteCalendarEventDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    GetMeetingEvents(
      variables: GetMeetingEventsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<GetMeetingEventsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetMeetingEventsQuery>({
            document: GetMeetingEventsDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    GetUpcomingMeetings(
      variables?: GetUpcomingMeetingsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<GetUpcomingMeetingsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUpcomingMeetingsQuery>({
            document: GetUpcomingMeetingsDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    GetPendingConfirmations(
      variables?: GetPendingConfirmationsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<GetPendingConfirmationsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetPendingConfirmationsQuery>({
            document: GetPendingConfirmationsDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    ConfirmMeeting(
      variables: ConfirmMeetingMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<ConfirmMeetingMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ConfirmMeetingMutation>({
            document: ConfirmMeetingDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    RejectMeeting(
      variables: RejectMeetingMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<RejectMeetingMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RejectMeetingMutation>({
            document: RejectMeetingDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    CreateMeeting(
      variables: CreateMeetingMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<CreateMeetingMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateMeetingMutation>({
