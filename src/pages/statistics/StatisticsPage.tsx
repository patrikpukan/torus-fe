...
const StatisticsPage = () => {
  ...
  // Build filter object based on current filter type
  const filter =
    filterType === "period"
      ? startDate && endDate
        ? { startDate, endDate }
      ...
      <Card>
        ...
        <CardContent>
          ...
          >
            ...
            <TabsContent value="month-year" className="space-y-4 mt-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
